...
public interface HomeworkStatusDao {
	...
	public HomeworkStatus findHomeworkStatus(String student_id, String cicos_id, String course_name, int exp_num) throws Exception;
	
	public List<HomeworkStatus> getSubmitHomework(String student_id) throws Exception;
	...
	public List<String> getOvertimeFileNameByCicosIDCourseNameExpNum(String cicos_id, String course_name, int exp_num) throws Exception;
