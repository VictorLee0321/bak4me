...
import cn.victorlee.service.FunctionService;
import cn.victorlee.service.HomeworkStatusService;
...
public class DAOFactory {
	...
	public static HomeworkStatusDao getHomeworkStatusDAOInstance() throws Exception {
		return new HomeworkStatusService();
	}
	
	public static FunctionDao getFunctionDAOInstance() throws Exception {
