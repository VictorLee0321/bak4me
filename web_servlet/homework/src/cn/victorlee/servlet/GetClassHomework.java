...
/**
 * Servlet implementation class GetClassHomework
 */
@WebServlet("/GetClassHomework")
public class GetClassHomework extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("get class homework cd do post");
		...
		try {
			...
			List<Course> course_list = DAOFactory.getCourseDAOInstance().getCourseByCicosID(cicos_id);
