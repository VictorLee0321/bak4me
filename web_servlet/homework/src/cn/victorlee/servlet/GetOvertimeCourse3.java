...
/**
 * Servlet implementation class GetOvertimeCourse3
 */
@WebServlet("/GetOvertimeCourse3")
public class GetOvertimeCourse3 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetOvertimeCourse3() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// get unsubmit course
		System.out.println("get overtime course3 cd do post");
